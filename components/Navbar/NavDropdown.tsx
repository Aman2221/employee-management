  ...
  return (
    <div className="relative">
      <div
        ...
        className={`${
          show ? "block" : "hidden"
        } z-10 absolute top-10 -left-44 md:-left-32  animate__animated animate__fadeIn bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600`}
      >
